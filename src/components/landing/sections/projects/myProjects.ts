...
export const myProjects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Файловый менеджер для хранения, организации и управления файлами, созданный как альтернатива привычным облачным хранилищам вроде Google Drive и Яндекс Диска. Интерфейс позволяет удобно работать с папками и файлами, просматривать содержимое хранилища и быстро находить нужные данные. Разрабатывался для внутреннего использования внутри компании.",
    languages: [
